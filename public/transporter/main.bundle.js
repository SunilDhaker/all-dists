...
var DashboardComponent = (function () {
    function DashboardComponent(_router, localStorageService) {
        ...
        // this.localStorageService.set("AUTH_TOKEN","eyJhbGciOiJIUzI1NiJ9..9f3SLZkxakk5YvoiLSQOk_HIS1mydKtjPBlWwG_stO4");
    }
...
var ShipmentFilter = (function () {
    ...
    ShipmentFilter.prototype.transform = function (input, config) {
        ...
        console.log(config);
        console.log(config);
        var list = input.filter(function (u) { return u['_shipmentState'][config[0]].toUpperCase().indexOf(config[1].toUpperCase()) != -1; });
        {
            return list;
        }
    };
