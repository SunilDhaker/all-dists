...
var ShipmentStatusComponent = (function () {
        ...
        this.unSub_allShipmentList = this._store.select('allShipmentList').subscribe(function (value) {
            if (value != null) {
                if (value['error'] == '') {
                    ...
                    _this.countShipment(_this.allShipment);
                    _this.isSpinner = false;
                    _this.isShowDetails = false;
                }
                else {
                    _this.openSnackBar(value['errorMsg']);
                    _this.isSpinner = false;
    ...
    ShipmentStatusComponent.prototype.countShipment = function (value) {
        this.active = 0;
        this.deliverd = 0;
    ...
    ShipmentStatusComponent.prototype.getDateTime = function (value) {
        console.log(value);
    };
    ...
    ShipmentStatusComponent.prototype.selectedShipmentDetail = function (shipment) {
        ...
        setTimeout(function () {
            _this.shipmentServices.getShipmentDetail.emit(id);
        }, 1000);
    };
...
/* unused harmony export TEST_BASE_IP */
