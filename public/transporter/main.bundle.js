...
var stores = { shipmentIdList: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["m" /* shipmentIdList */],
    allShipmentList: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["c" /* allShipmentList */],
    shipmentDetail: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["k" /* shipmentDetail */],
    newShipment: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["j" /* newShipment */],
    allDevicesList: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["b" /* allDevicesList */],
    checkVehicle: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["d" /* checkVehicle */],
    deviceDetails: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["i" /* deviceDetails */],
    closeDialog: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["e" /* closeDialog */],
    createOrgRes: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["g" /* createOrgRes */],
    switchOrganisationResp: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["n" /* switchOrganisationResp */],
    customerDetails: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["h" /* customerDetails */],
    shipmentGroupList: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["l" /* shipmentGroupList */],
    createGroupRes: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["f" /* createGroupRes */],
    deleteUserResponse: __WEBPACK_IMPORTED_MODULE_45__reducers_user_management_store__["a" /* deleteUserResponse */],
    getAllUserList: __WEBPACK_IMPORTED_MODULE_45__reducers_user_management_store__["c" /* getAllUserList */],
    updateUserStatusResponse: __WEBPACK_IMPORTED_MODULE_45__reducers_user_management_store__["d" /* updateUserStatusResponse */],
    existingUserResponse: __WEBPACK_IMPORTED_MODULE_45__reducers_user_management_store__["b" /* existingUserResponse */],
    switchShipment: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["o" /* switchShipment */],
    addDevice: __WEBPACK_IMPORTED_MODULE_27__reducers_info_store__["a" /* addDevice */]
};
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_24__angular_http__["c" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_24__angular_http__["d" /* JsonpModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_25__ngrx_store__["b" /* StoreModule */].provideStore(stores),
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_7__angular_material__["k" /* MdIconRegistry */],
            __WEBPACK_IMPORTED_MODULE_13__angular_forms__["NgModel"], __WEBPACK_IMPORTED_MODULE_25__ngrx_store__["b" /* StoreModule */], __WEBPACK_IMPORTED_MODULE_20__services_shipment_services__["a" /* ShipmentServices */],
            __WEBPACK_IMPORTED_MODULE_23__services_device_services__["a" /* DeviceServices */], __WEBPACK_IMPORTED_MODULE_2__agm_core__["c" /* GoogleMapsAPIWrapper */], __WEBPACK_IMPORTED_MODULE_21__services_tracker_services__["a" /* TrackerServices */],
...
var DashboardComponent = (function () {
    function DashboardComponent(_router, localStorageService) {
        ...
        // this.localStorageService.set("AUTH_TOKEN","eyJhbGciOiJIUzI1NiJ9..Ug--W9YLCcWJvmIpv_a4eRF0WW4dd9ScGXeufx3N4DA");
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_material__ = __webpack_require__("../../../material/@angular/material.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_dialog_confirm_device_return_confirm_device_return_component__ = __webpack_require__("../../../../../src/app/components/dialog/confirm-device-return/confirm-device-return.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_dialog_assign_vehicle_assign_vehicle_component__ = __webpack_require__("../../../../../src/app/components/dialog/assign-vehicle/assign-vehicle.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_dialog_mark_as_required_mark_as_required_component__ = __webpack_require__("../../../../../src/app/components/dialog/mark-as-required/mark-as-required.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DeviceDashboard = (function () {
    ...
    DeviceDashboard.prototype.confirmAddDevice = function () {
        ...
        if (Object(__WEBPACK_IMPORTED_MODULE_4_util__["isNullOrUndefined"])(this.deviceIMEI) || this.deviceIMEI == 0) {
    ...
    DeviceDashboard.prototype.openDialogConfirmDeviceReturn = function (device) {
        ...
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_6__components_dialog_confirm_device_return_confirm_device_return_component__["a" /* ConfirmDeviceReturnComponent */]);
    ...
    DeviceDashboard.prototype.openDialogAssignVehicle = function (device) {
        ...
        console.log(res);
        this._store.dispatch({ type: "DEVICE_DETAILS", payload: { error: '', data: res } });
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_7__components_dialog_assign_vehicle_assign_vehicle_component__["a" /* AssignVehicleComponent */], {
    ...
    DeviceDashboard.prototype.openDialogMarkAsRequired = function (device) {
        ...
        console.log(res);
        this._store.dispatch({ type: "DEVICE_DETAILS", payload: { error: '', data: res } });
        var dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_8__components_dialog_mark_as_required_mark_as_required_component__["a" /* MarkAsRequiredComponent */], {
            height: '350px', width: '500px'
        });
        dialogRef.afterClosed().subscribe(function (result) {
            console.log("Dialog result: " + result);
...
var UserProfile = (function () {
    ...
    UserProfile.prototype.getOrganization = function (token) {
        var _this = this;
        this.orgList = [];
        var path = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["b" /* paths */].ORGANIZATION_LIST_PATH;
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */](this.defaultHeaders.toJSON());
        headers.set('Content-Type', 'application/json');
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["m"] = shipmentIdList;
/* harmony export (immutable) */ __webpack_exports__["c"] = allShipmentList;
/* harmony export (immutable) */ __webpack_exports__["k"] = shipmentDetail;
/* harmony export (immutable) */ __webpack_exports__["j"] = newShipment;
/* harmony export (immutable) */ __webpack_exports__["b"] = allDevicesList;
/* harmony export (immutable) */ __webpack_exports__["d"] = checkVehicle;
/* harmony export (immutable) */ __webpack_exports__["o"] = switchShipment;
/* harmony export (immutable) */ __webpack_exports__["i"] = deviceDetails;
/* harmony export (immutable) */ __webpack_exports__["a"] = addDevice;
/* harmony export (immutable) */ __webpack_exports__["e"] = closeDialog;
/* harmony export (immutable) */ __webpack_exports__["g"] = createOrgRes;
/* harmony export (immutable) */ __webpack_exports__["n"] = switchOrganisationResp;
/* harmony export (immutable) */ __webpack_exports__["h"] = customerDetails;
/* harmony export (immutable) */ __webpack_exports__["l"] = shipmentGroupList;
/* harmony export (immutable) */ __webpack_exports__["f"] = createGroupRes;
...
var DeviceServices = (function () {
    function DeviceServices(http, _store, localStorageService) {
        ...
        this.allDevicesList.subscribe(function () {
            ...
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].DEVICE_LIST_PATH;
            // console.log(path);
        ...
        this.addDevice.subscribe(function (device) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].DEVICE_ADD_PATH;
...
var ManualShipmentServices = (function () {
    function ManualShipmentServices(http, _store, localStorgeService, shipmentServices) {
        ...
        this.pickup.subscribe(function (pickUp) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/missing/pickup';
            console.log(path);
        ...
        this.addStop.subscribe(function (addstop) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/addstop';
        ...
        this.delivery.subscribe(function (deliveryy) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/missing/delivery';
...
var ShipmentMgmtService = (function () {
    function ShipmentMgmtService(http, _store, localStorageService) {
        ...
        this.getAllShipmentGroupsList.subscribe(function (orgId) {
            ...
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].MANAGE_VEHICLES_GRP_PATH + "/get";
            // console.log(path);
        ...
        this.createNewShipmentGroup.subscribe(function (groupObj) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].MANAGE_VEHICLES_GRP_PATH + "/create";
            console.log(path);
            console.log(groupObj);
...
var ShipmentServices = (function () {
    function ShipmentServices(http, _store, localStorgeService) {
        ...
        this.getShipmentList.subscribe(function () {
            var path = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/dashboard';
            console.log(path);
        ...
        this.getShipmentDetail.subscribe(function (id) {
            var path = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/detail/' + id;
            console.log(path);
        ...
        this.createNewShipment.subscribe(function (shipment) {
            var path = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/create';
            console.log(path);
        ...
        this.switchShipmentDetail.subscribe(function (shipment) {
            var path = __WEBPACK_IMPORTED_MODULE_4__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/switch/trackmode';
            console.log(path);
    ...
    function TrackerServices(http, _store, localStorageService) {
        ...
        this.discardTrackerTrip.subscribe(function (discard) {
            ...
            if (discard['forEditPlace'] == 'destination') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/discard/delivery";
            }
            else if (discard['forEditPlace'] == 'pickup') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/discard/pickup";
            }
            console.log(path);
        ...
        this.updateTrackerTrip.subscribe(function (updateTripObj) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + '/update';
            console.log(path);
        ...
        this.updateTrackerTripFromStop.subscribe(function (tripObj) {
            ...
            if (tripObj['forEditPlace'] == 'destination') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/selectfromstop/delivery";
            }
            else if (tripObj['forEditPlace'] == 'pickup') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/selectfromstop/pickup";
            }
            console.log(path);
        ...
        this.confirmLocation.subscribe(function (obj) {
            ...
            if (obj['forConfirmPlace'] == 'Destination') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/missing/delivery";
            }
            else if (obj['forConfirmPlace'] == 'Pickup') {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].SHIPMENT_PATH + "/missing/pickup";
            }
            console.log(path);
...
var UserManagementService = (function () {
    function UserManagementService(http, _store, localStorageService) {
        ...
        this.getAllUsersList.subscribe(function (token) {
            _this.token = token;
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].MANAGE_USERS_PATH;
            console.log(path);
        ...
        this.deleteUser.subscribe(function (userObj) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].DELETE_USERS_PATH + "/remove";
            console.log(path);
            console.log(userObj);
        ...
        this.changeUserType.subscribe(function (userObj) {
            var path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].DELETE_USERS_PATH + "/add";
            console.log(path);
            console.log(userObj);
        ...
        this.getUserIfExist.subscribe(function (newUserObj) {
            var path = "";
            if (newUserObj['email'] != "") {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].ADD_EXISTING_USERS_PATH + "?email=" + newUserObj['email'];
            }
            if (newUserObj['mobile'] != "") {
                path = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["b" /* paths */].ADD_EXISTING_USERS_PATH + "?mobile=" + newUserObj['mobile'];
            }
            console.log(path);
