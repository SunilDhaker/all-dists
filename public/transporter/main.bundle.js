                    ...
                    if (value['res']['exist'] == true) {
                        ...
                        if (value['res']['latestGpsState'] != null) {
                            if (value['res']['latestGpsState']['state'] == "Disconnected" || value['res']['latestGpsState']['state'] == null || value['res']['latestGpsState']['state'] == "Suspended") {
                                if ((value['res']['latestGpsState']['endTime'] - value['res']['latestGpsState']['startTime']) / 3600000 > 24) {
                                    _this.sinceTime = 'Since ' + _this.msToTime(value['res']['latestGpsState']['endTime'] - value['res']['latestGpsState']['startTime']);
                                    _this.isShowTripDisconnected = true;
                                }
                            }
                            else {
                                _this.isShowTripDisconnected = false;
                            }
                        }
                        else {
                            _this.isShowTripDisconnected = true;
                            _this.sinceTime = 'Suspended';
                        }
